 ...
 export const createTrabaja = async ({ email, telefono, documento, numIdentidad, nombre, primerApellido, segundoApellido, fechaNacimiento, codigoPostal, ciudad, direccion }) => {
